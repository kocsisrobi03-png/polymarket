...
def get_kalshi_category(raw_item):
    return normalize_text(safe_str(raw_item.get("category")))
...
def kalshi_mode_allows_type(market_type, raw_item=None):
    ...
    category = get_kalshi_category(raw_item or {})
    ...
    if market_type in KALSHI_ALLOWED_TYPES:
        return True
